...
### Informationelle Selbstbestimmung stärken, Medienkompetenz fördern {#informationelle_selbstbestimmung_stärken_medienkompetenz_fördern}
...
### Datenschutzbehörden stärken {#datenschutzbehörden_stärken}
...
### Verantwortungsvollen Umgang mit Meldedaten sicherstellen, Datenhandel eindämmen {#verantwortungsvollen_umgang_mit_meldedaten_sicherstellen_datenhandel_eindämmen}
...
### Schluss mit Vorratsdatenspeicherung und Videoüberwachung {#schluss_mit_vorratsdatenspeicherung_und_videoüberwachung}
...
### Keine Einschränkungen beim Bargeldverkehr {#keine_einschränkungen_beim_bargeldverkehr}
...
### Gegen Überwachungssoftware: Transparenz und Quellcode-Offenlegung {#gegen_überwachungssoftware_transparenz_und_quellcode_offenlegung}
...
### „Digitale Netzwerke" ins Grundgesetz {#digitale_netzwerke_ins_grundgesetz}
...
### Betroffene von Überwachungsmaßnahmen müssen informiert werden {#betroffene_von_überwachungsmaßnahmen_müssen_informiert_werden}
...
### Keine Bundes- oder Staatstrojaner {#keine_bundes__oder_staatstrojaner}

#### Verdeckte Eingriffe in informationstechnische Systeme (z. B. Bundes- oder Staatstrojaner) {#verdeckte_eingriffe_in_informationstechnische_systeme_z._b._bundes__oder_staatstrojaner}
...
### Schutz der Privatsphäre im Grundgesetz {#schutz_der_privatsphäre_im_grundgesetz}
...
# **Asyl und Migration** {#asyl_und_migration}

## Für eine solidarische Asylpolitik -- Menschenrechte gelten für alle! {#für_eine_solidarische_asylpolitik_menschenrechte_gelten_für_alle}
...
### Ursachenbekämpfung, Konfliktprävention {#ursachenbekämpfung_konfliktprävention}
...
### Für ein liberales Aufenthaltsrecht {#für_ein_liberales_aufenthaltsrecht}

#### Erleichterung des Ehegattennachzugs {#erleichterung_des_ehegattennachzugs}
...
### Wiederherstellung des Rechts auf Asyl, Asylgründe erweitern und Hürden für Aufenthaltserlaubnis senken {#wiederherstellung_des_rechts_auf_asyl_asylgründe_erweitern_und_hürden_für_aufenthaltserlaubnis_senken}
...
### Grundrechte auf alle Menschen ausweiten {#grundrechte_auf_alle_menschen_ausweiten}
...
### Keine Rückkehr zur Drittstaatenregelung {#keine_rückkehr_zur_drittstaatenregelung}
...
### Offenere Grenzen statt der Festung Europa {#offenere_grenzen_statt_der_festung_europa}
...
### Schaffung einer europäischen Seenotrettungsorganisation {#schaffung_einer_europäischen_seenotrettungsorganisation}
...
### Keine Abwehr von Flüchtenden {#keine_abwehr_von_flüchtenden}
...
### Keine Drohnen gegen Flüchtende {#keine_drohnen_gegen_flüchtende}
...
### Freie Wahl des Aufenthaltsortes für alle Menschen {#freie_wahl_des_aufenthaltsortes_für_alle_menschen}
...
### Isolation beenden -- menschenwürdige und dezentrale Unterkünfte schaffen! {#isolation_beenden_menschenwürdige_und_dezentrale_unterkünfte_schaffen}
...
### Faires Asylverfahren schaffen -- Behördengänge vereinfachen, rechtsstaatliches Asylverfahren sicherstellen {#faires_asylverfahren_schaffen_behördengänge_vereinfachen_rechtsstaatliches_asylverfahren_sicherstellen}
...
### Keine Illegalisierung von Papierlosen {#keine_illegalisierung_von_papierlosen}
...
### Für ein Ende von Abschiebungen und Abschiebehaft {#für_ein_ende_von_abschiebungen_und_abschiebehaft}
...
### Echte Existenzsicherung statt diskriminierender Sondergesetze {#echte_existenzsicherung_statt_diskriminierender_sondergesetze}
...
### Finanzierung zur Versorgung der aufgenommenen Geflüchteten {#finanzierung_zur_versorgung_der_aufgenommenen_geflüchteten}
...
### Staatsangehörigkeit -- mehrfach und durch Geburt {#staatsangehörigkeit_mehrfach_und_durch_geburt}
...
## Für eine echte Migrationspolitik {#für_eine_echte_migrationspolitik}
...
### Für eine moderne, weltoffene Verwaltung {#für_eine_moderne_weltoffene_verwaltung}
...
#### Unabhängigkeit und Kompetenz für die zuständigen Akteure {#unabhängigkeit_und_kompetenz_für_die_zuständigen_akteure}
...
#### Abschaffung des Mehr-Klassen-Systems auf dem Arbeitsmarkt {#abschaffung_des_mehr_klassen_systems_auf_dem_arbeitsmarkt}
...
#### Anerkennung ausländischer Berufs- und Schulabschlüsse und Fähigkeiten {#anerkennung_ausländischer_berufs__und_schulabschlüsse_und_fähigkeiten}
...
#### Freier Zugang zu Deutschkursen {#freier_zugang_zu_deutschkursen}
...
## Piraten für Fanrechte {#piraten_für_fanrechte}
...
### Gegen Kollektivstrafen {#gegen_kollektivstrafen}
...
### Gewalttäter Sport {#gewalttäter_sport}
...
### Keine Einschränkungen der Freiheit der Person {#keine_einschränkungen_der_freiheit_der_person}
...
# **Demokratie wagen** {#demokratie_wagen}

## Wahlrecht

### Einführung von offenen Listen, Kumulieren und Panaschieren {#einführung_von_offenen_listen_kumulieren_und_panaschieren}
...
### Absenkung des Wahlalters {#absenkung_des_wahlalters}
...
### Für die Teilhabe aller Menschen {#für_die_teilhabe_aller_menschen}
...
#### Wahlrecht und Bürgerbeteiligung für alle Menschen {#wahlrecht_und_bürgerbeteiligung_für_alle_menschen}
...
#### Stärkung der Interessenvertretung aller Menschen {#stärkung_der_interessenvertretung_aller_menschen}
...
### Direkte Demokratie {#direkte_demokratie}
...
### OPENANTRAG für den Bundestag {#openantrag_für_den_bundestag}
...
### Eine offene Plattform zur Kommunikation mit den Vertretern im Parlament {#eine_offene_plattform_zur_kommunikation_mit_den_vertretern_im_parlament}
...
## Einführung bundesweiter Volksentscheide {#einführung_bundesweiter_volksentscheide}
...
### Einführung eines dreistufigen Verfahrens bei Initiativen aus dem Volk {#einführung_eines_dreistufigen_verfahrens_bei_initiativen_aus_dem_volk}
...
### Fakultatives Referendum {#fakultatives_referendum}
...
### Obligatorisches Referendum {#obligatorisches_referendum}
...
## Jugendparlament auf Bundesebene {#jugendparlament_auf_bundesebene}
...
# **Digitalisierung und Netzpolitik** {#digitalisierung_und_netzpolitik}

## Netzneutralität stärken und gesetzlich verankern {#netzneutralität_stärken_und_gesetzlich_verankern}
...
## Mauer der digitalen Spaltung überwinden {#mauer_der_digitalen_spaltung_überwinden}
...
## Bereitstellung von Internetzugängen {#bereitstellung_von_internetzugängen}
...
### Freie, rechtskräftige digitale Signaturen und E-Mail-Verschlüsselung für alle {#freie_rechtskräftige_digitale_signaturen_und_e_mail_verschlüsselung_für_alle}
...
### Gesetzliche Garantie für den anonymen, sowie autonymen und pseudonymen Zugang zu Netzdiensten {#gesetzliche_garantie_für_den_anonymen_sowie_autonymen_und_pseudonymen_zugang_zu_netzdiensten}
...
### Abschaffung des „Hackerparagraphen" § 202c StGB {#abschaffung_des_hackerparagraphen_202c_stgb}
...
## Schutz der Freiheit und Privatsphäre im Internet {#schutz_der_freiheit_und_privatsphäre_im_internet}
...
## Freier Zugang zu öffentlichen Inhalten {#freier_zugang_zu_öffentlichen_inhalten}
...
### Freie Bildung und Forschung {#freie_bildung_und_forschung}
...
### Forschung und Wissenschaft {#forschung_und_wissenschaft}
...
### Gemeinfreiheit aller amtlichen Werke {#gemeinfreiheit_aller_amtlichen_werke}
...
## Datenschutz und IT-Sicherheit {#datenschutz_und_it_sicherheit}
...
## Algorithmen und Künstliche Intelligenz (KI) als Schlüsseltechnologien für eine moderne Gesellschaft {#algorithmen_und_künstliche_intelligenz_ki_als_schlüsseltechnologien_für_eine_moderne_gesellschaft}
...
## Innovative digitale und klimafreundliche Verkehrskonzepte {#innovative_digitale_und_klimafreundliche_verkehrskonzepte}
...
## Gesundheit, Pflege, Medizin {#gesundheit_pflege_medizin}
...
## Unabhängigkeit des Bundesamts für Sicherheit in der Informationstechnik (BSI) {#unabhängigkeit_des_bundesamts_für_sicherheit_in_der_informationstechnik_bsi}
...
## Personalausstattung IT-sicherheitsrelevanter Behörden {#personalausstattung_it_sicherheitsrelevanter_behörden}
...
## Open Source in kritischen Infrastrukturen {#open_source_in_kritischen_infrastrukturen}
...
## Strikt defensive Cybersicherheitsstrategie {#strikt_defensive_cybersicherheitsstrategie}
...
## Aufbau eines Cyber-Hilfswerks (CHW) {#aufbau_eines_cyber_hilfswerks_chw}
...
## Aufsicht über kritische Infrastrukturen {#aufsicht_über_kritische_infrastrukturen}
...
## Digitale Unversehrtheit als Grundrecht {#digitale_unversehrtheit_als_grundrecht}
...
## Transparenter Staat und digitale Grundrechte {#transparenter_staat_und_digitale_grundrechte}
...
## Netzneutralität stärken und gesetzlich verankern {#netzneutralität_stärken_und_gesetzlich_verankern_1}

Wir PIRATEN setzen uns für eine gesetzliche Festschreibung des neutralen Charakters der Datendurchleitung im Internet ein (Prinzip der Netzneutralität), um Informations-, Presse- und Meinungsfreiheit zu sichern und die Innovationsfähigkeit des Netzes zu erhalten. Die Netzneutralität muss bedingungslos ermöglicht werden!

## Freier Zugang {#freier_zugang}
...
## Ländlicher Raum {#ländlicher_raum}
...
## Moderne, nachhaltige und digitale Landwirtschaft {#moderne_nachhaltige_und_digitale_landwirtschaft}
...
## Barrierefreie Kommunikation {#barrierefreie_kommunikation}
...
### Ableismus bekämpfen {#ableismus_bekämpfen}
...
### Universelles Design {#universelles_design}
...
## Bildung und Arbeit {#bildung_und_arbeit}

### Inklusive Bildung {#inklusive_bildung}
...
### Chancengleichheit durch Digitalisierung {#chancengleichheit_durch_digitalisierung}
...
### Inklusive Arbeitswelt {#inklusive_arbeitswelt}
...
### Individuelle Anforderungen behinderter Menschen in Bildung und Arbeit stärker berücksichtigen {#individuelle_anforderungen_behinderter_menschen_in_bildung_und_arbeit_stärker_berücksichtigen}
...
## Politische Teilhabe {#politische_teilhabe}

### Repräsentation in politischen Gremien {#repräsentation_in_politischen_gremien}
...
### Inklusivere politische Kommunikation {#inklusivere_politische_kommunikation}
...
## Barrierefreiheit und Mobilität {#barrierefreiheit_und_mobilität}

### Öffentlicher Raum {#öffentlicher_raum}
...
### Private Barrierefreiheit {#private_barrierefreiheit}
...
### Digitale Barrierefreiheit {#digitale_barrierefreiheit}
...
### Menschenwürdige Gehwege {#menschenwürdige_gehwege}
...
## Gesundheit und Pflege {#gesundheit_und_pflege}

### Inklusive Gesundheitsversorgung {#inklusive_gesundheitsversorgung}
...
### Selbstbestimmte Pflege und Wohnen {#selbstbestimmte_pflege_und_wohnen}
...
### Pandemischer Schutz {#pandemischer_schutz}
...
## Rechtliche Gleichstellung {#rechtliche_gleichstellung}

### Umsetzung der UN-BRK {#umsetzung_der_un_brk}
...
### Standards einhalten {#standards_einhalten}
...
## Bewusstseinsbildung und Sichtbarkeit {#bewusstseinsbildung_und_sichtbarkeit}

### Mediale Repräsentation {#mediale_repräsentation}
...
### Inklusive Kulturangebote {#inklusive_kulturangebote}
...
## Forschung und Innovation {#forschung_und_innovation}

### Inklusive Technologien {#inklusive_technologien}
...
## Behindertengerechter Klimawandel {#behindertengerechter_klimawandel}

### Inklusive Klimapolitik {#inklusive_klimapolitik}
...
### Forschung und internationale Zusammenarbeit {#forschung_und_internationale_zusammenarbeit}
...
## Förderung von Sozialen Trägerschaften und Behindertenhilfe {#förderung_von_sozialen_trägerschaften_und_behindertenhilfe}

### Entbürokratisierung und finanzielle Stärkung {#entbürokratisierung_und_finanzielle_stärkung}
...
### Inklusive Arbeitswelt und Unternehmensverantwortung {#inklusive_arbeitswelt_und_unternehmensverantwortung}
...
### Förderung von Fachpersonal und politische Teilhabe {#förderung_von_fachpersonal_und_politische_teilhabe}
...
# **Bildung und Forschung** {#bildung_und_forschung}
...
## Finanzierung der Bildung {#finanzierung_der_bildung}
...
Die PIRATEN fordern die Möglichkeit der freien Wahl des Lernortes und wollen daher die Anwesenheitspflicht in der Schulpfllicht entfernen, so dass die Möglichkeit besteht, eine duale Ausbildung in den Lehrplan zu integrieren. Wir empfehlen, diese Möglichkeit für Jugendliche ab 14 Jahren anzubieten.

## Bildung hat keine Grenzen {#bildung_hat_keine_grenzen}
...
## Frühkindliche Bildung {#frühkindliche_bildung}
...
Ausreichender Schlaf ist für die Bildung eines Langzeitgedächtnisses von grundsätzlicher Bedeutung. Studien hierzu zeigen, dass die Abendtypen, wenn sie früh morgens Leistungen erbringen müssen, schlechtere Leistungen erbringen, als die Morgentypen. Dieser Effekt ist bei Jugendlichen stärker ausgeprägt als bei Studierenden. Schulen sollten in die Lage versetzt werden, diesen Erkenntnissen mit der Anpassung ihrer Unterrichtsstruktur Rechnung zu tragen, um Lernzeit auf den individuellen Biorhythmus anzupassen und diesen selbstbestimmt zu wählen.

## Zeit für Bildung {#zeit_für_bildung}
...
## Digitalen Lernraum gestalten {#digitalen_lernraum_gestalten}
...
## Teilhabe an Bildung {#teilhabe_an_bildung}
...
## Berufsschule und Duale Ausbildung {#berufsschule_und_duale_ausbildung}
...
### Unbegrenzte Arbeitsmöglichkeiten für Akademiker -- Änderung des Wissenschaftszeitvertragsgesetzes (WissZeitVG) {#unbegrenzte_arbeitsmöglichkeiten_für_akademiker_änderung_des_wissenschaftszeitvertragsgesetzes_wisszeitvg}
...
### Freier Zugang zu Bildung und Wissenschaft {#freier_zugang_zu_bildung_und_wissenschaft}
...
#### OER (Open Educational Resources) {#oer_open_educational_resources}
...
#### OER - Freie Bildungsmaterialien im Hochschulbereich {#oer___freie_bildungsmaterialien_im_hochschulbereich}
...
#### Freier Zugang zu allen aus Steuermitteln finanzierten Forschungsergebnissen (Open Access) {#freier_zugang_zu_allen_aus_steuermitteln_finanzierten_forschungsergebnissen_open_access}

##### Förderung von Veröffentlichungen unter freier Lizenz {#förderung_von_veröffentlichungen_unter_freier_lizenz}
...
##### Universitätsnahe Umsetzung {#universitätsnahe_umsetzung}
...
##### Offene Dateiformate {#offene_dateiformate}
...
##### Abbau von Zugangsbeschränkungen {#abbau_von_zugangsbeschränkungen}
...
### Open Access in der Entwicklungspolitik {#open_access_in_der_entwicklungspolitik}
...
## Patente und Markenrecht {#patente_und_markenrecht}

### Konkrete Reformvorschläge für das Patentwesen {#konkrete_reformvorschläge_für_das_patentwesen}
...
#### Patentierbare Erfindungen {#patentierbare_erfindungen}
...
### Kurzfristige Maßnahmen zur Verbesserung des Patentrechts {#kurzfristige_maßnahmen_zur_verbesserung_des_patentrechts}
...
#### Gerichtskosten bei Patentstreitigkeiten vom Streitwert entkoppeln {#gerichtskosten_bei_patentstreitigkeiten_vom_streitwert_entkoppeln}
...
#### Nutzungsbindung von Patenten {#nutzungsbindung_von_patenten}
...
#### Bekämpfung von wettbewerbswidrigem Patentmissbrauch {#bekämpfung_von_wettbewerbswidrigem_patentmissbrauch}
...
#### Mittelfristige Demokratisierung des Patentvergabeprozesses {#mittelfristige_demokratisierung_des_patentvergabeprozesses}
...
#### Langfristige Aufgabe des Patentsystems zugunsten des wettbewerbsgetriebenen Fortschritts {#langfristige_aufgabe_des_patentsystems_zugunsten_des_wettbewerbsgetriebenen_fortschritts}
...
# **Umwelt, Landwirtschaft, Tier- und Verbraucherschutz** {#umwelt_landwirtschaft_tier__und_verbraucherschutz}
...
#### Einführung eines Umweltgesetzbuches und Abschaffung des Bergrechts {#einführung_eines_umweltgesetzbuches_und_abschaffung_des_bergrechts}
...
### Regionale Vielfalt erhalten, nutzen, weiterentwickeln {#regionale_vielfalt_erhalten_nutzen_weiterentwickeln}
...
### Boden wertschätzen jenseits von Spekulationsgedanken {#boden_wertschätzen_jenseits_von_spekulationsgedanken}
...
### Humus aufbauen und erhalten {#humus_aufbauen_und_erhalten}
...
### Pflanzenkohle einsetzen {#pflanzenkohle_einsetzen}
...
### Nutz- und Wildtiere mit Respekt behandeln {#nutz__und_wildtiere_mit_respekt_behandeln}
...
### Lieferketten transparent machen {#lieferketten_transparent_machen}
...
### Saatgut samenfest machen {#saatgut_samenfest_machen}
...
### Keine Patente auf Leben {#keine_patente_auf_leben}

Dieser Grundsatz muss strikt umgesetzt werden.

## Digitalisierung sinnvoll einsetzen {#digitalisierung_sinnvoll_einsetzen}
...
### Erweiterung des Tierschutzgesetzes {#erweiterung_des_tierschutzgesetzes}
...
### Gegen die geplante Obsoleszenz {#gegen_die_geplante_obsoleszenz}
...
### Herstellung der Gerätehoheit {#herstellung_der_gerätehoheit}
...
## Das wollen wir wie folgt erreichen: {#das_wollen_wir_wie_folgt_erreichen}

## Photovoltaik ist das Arbeitspferd der Energiewende {#photovoltaik_ist_das_arbeitspferd_der_energiewende}
...
## Windenergie als Ergänzung {#windenergie_als_ergänzung}
...
## Energetische Nutzung von Biogas und Biotreibstoffen {#energetische_nutzung_von_biogas_und_biotreibstoffen}
...
## Geothermie und Wasserkraft {#geothermie_und_wasserkraft}
...
## Kohleausstieg beschleunigen {#kohleausstieg_beschleunigen}
...
## Power-to-Gas / Wasserstoff / eFuels {#power_to_gas_wasserstoff_efuels}
...
## Dezentrale Versorgungs- und Netzstruktur {#dezentrale_versorgungs__und_netzstruktur}
...
## Eigenverbrauch von selbst erzeugtem Strom abgabenfrei {#eigenverbrauch_von_selbst_erzeugtem_strom_abgabenfrei}
...
## Netzentgelte entfernungsabhängig berechnen {#netzentgelte_entfernungsabhängig_berechnen}
...
## Stromtrassen und innereuropäischer Strommarkt {#stromtrassen_und_innereuropäischer_strommarkt}
...
## Strommarkt und Peer-to-Peer Stromhandel {#strommarkt_und_peer_to_peer_stromhandel}
...
## Bundesnetzagentur (BNetzA) reformieren {#bundesnetzagentur_bnetza_reformieren}
...
## Abschaffung von Subventionen und Beihilfen für die Energiegewinnung {#abschaffung_von_subventionen_und_beihilfen_für_die_energiegewinnung}
...
## Haftung für die Folgekosten fossiler Energiegewinnung {#haftung_für_die_folgekosten_fossiler_energiegewinnung}
...
## Sektorenkopplung auf Strom ausrichten {#sektorenkopplung_auf_strom_ausrichten}
...
## Datenschutz im Energiesektor {#datenschutz_im_energiesektor}
...
## Atomenergie und Atommüll {#atomenergie_und_atommüll}
...
## Versuchsreaktoren und technische/medizinische Radionuklide {#versuchsreaktoren_und_technischemedizinische_radionuklide}
...
## Transparenz und Bürgerbeteiligung {#transparenz_und_bürgerbeteiligung}
...
## Schlüsseltechnologien ansiedeln {#schlüsseltechnologien_ansiedeln}
...
# **Bauen und Verkehr** {#bauen_und_verkehr}
...
## Sozial gerechte Bodennutzung {#sozial_gerechte_bodennutzung}
...
## Verkehrs- und Stadtentwicklung {#verkehrs__und_stadtentwicklung}
...
## Bürgerbeteiligung {#bürgerbeteiligung_1}
...
## Bauen und Wohnen überall in Deutschland {#bauen_und_wohnen_überall_in_deutschland}

### Bezahlbarer Wohnraum {#bezahlbarer_wohnraum}
...
Die Förderung des sozialen Wohnungsbaus kommt vielen Menschen und der lokalen Wirtschaft zugute und muss deutlich verstärkt werden. Die ursprünglich für den sozialen Wohnungsbau dauerhaft vorgesehenen Geldmittel müssen reaktiviert werden und ab sofort streng zweckgebunden verwendet werden.
...
### Intelligente Städte und Regionen {#intelligente_städte_und_regionen}
...
### Quartierslösungen für die Energieversorgung {#quartierslösungen_für_die_energieversorgung}
...
## Eine ganz neue Verkehrspolitik {#eine_ganz_neue_verkehrspolitik}
...
### Die Verkehrsinfrastruktur muss dauerhaft funktionieren {#die_verkehrsinfrastruktur_muss_dauerhaft_funktionieren}
...
### Güterverkehr auf die Schiene {#güterverkehr_auf_die_schiene}
...
### Nachhaltiges Fliegen unterstützen {#nachhaltiges_fliegen_unterstützen}
...
### Vernetzter Verkehr als Wahlfreiheit für alle {#vernetzter_verkehr_als_wahlfreiheit_für_alle}
...
### Emissionsfreier Verkehr {#emissionsfreier_verkehr}
...
### Open Data für die Verkehrswende {#open_data_für_die_verkehrswende}
...
### Ausschreibungen und Vergabekriterien für öffentliche Verkehrsprojekte {#ausschreibungen_und_vergabekriterien_für_öffentliche_verkehrsprojekte}
...
### Autonomes Fahren {#autonomes_fahren}
...
# **Kunst und Kultur** {#kunst_und_kultur}
...
### Stärkung von Nutzern {#stärkung_von_nutzern}
...
### Stärkung von Urhebern {#stärkung_von_urhebern}
...
### Förderung alternativer Vertriebsmodelle {#förderung_alternativer_vertriebsmodelle}
...
## Anerkennung und Förderung von \"eSport\" auf nationaler Ebene {#anerkennung_und_förderung_von_esport_auf_nationaler_ebene}
...
# **Arbeit und Soziales** {#arbeit_und_soziales}
...
## Zukunft der Erwerbsarbeit {#zukunft_der_erwerbsarbeit}

### Die Arbeitswelt im Zeichen der Digitalisierung {#die_arbeitswelt_im_zeichen_der_digitalisierung}

#### Flexible Wahl des Arbeitsorts {#flexible_wahl_des_arbeitsorts}
...
#### Einklang von Erwerbs- und Privatleben {#einklang_von_erwerbs__und_privatleben}
...
#### Atypische Beschäftigungsverhältnisse {#atypische_beschäftigungsverhältnisse}
...
##### Gleiche Behandlung für gleiche Leistung {#gleiche_behandlung_für_gleiche_leistung}
...
##### Arbeitnehmerüberlassung im SGB {#arbeitnehmerüberlassung_im_sgb}
...
### Erwerbssuchende unterstützen {#erwerbssuchende_unterstützen}

#### Förderung qualifizierter/älterer arbeitssuchender Menschen {#förderung_qualifizierterälterer_arbeitssuchender_menschen}
...
#### Qualitätsstandards für die Vermittlung in Arbeit (Jobcenter) {#qualitätsstandards_für_die_vermittlung_in_arbeit_jobcenter}
...
#### Akteneinsicht/Transparenz in Jobcentern {#akteneinsichttransparenz_in_jobcentern}
...
#### Stärkung der Arbeitslosen-Selbsthilfegruppen {#stärkung_der_arbeitslosen_selbsthilfegruppen}
...
#### Transparenz bei Arbeitslosenstatistik {#transparenz_bei_arbeitslosenstatistik}
...
### Rechte der Arbeitnehmer stärken {#rechte_der_arbeitnehmer_stärken}

#### Mitbestimmung {#mitbestimmung_1}
...
#### Maßnahmen gegen Mobbing {#maßnahmen_gegen_mobbing}
...
### Gerechte Entlohnung {#gerechte_entlohnung}

#### Flächendeckender gesetzlicher Mindestlohn muss Erwerbstätigen ein existenzsicherndes Einkommen bieten {#flächendeckender_gesetzlicher_mindestlohn_muss_erwerbstätigen_ein_existenzsicherndes_einkommen_bieten}
...
#### Missbrauch von Berufspraktika verhindern {#missbrauch_von_berufspraktika_verhindern}
...
#### Bekämpfung von „prekärem Unternehmertum" {#bekämpfung_von_prekärem_unternehmertum}
...
#### Sofortige Aussetzung von Arbeitsgelegenheiten (§ 16d SGB II) {#sofortige_aussetzung_von_arbeitsgelegenheiten_16d_sgb_ii}
...
#### Anhebung der Verdienstgrenze für Minijobs {#anhebung_der_verdienstgrenze_für_minijobs}
...
## ILA -- International Liberty Agreement {#ila_international_liberty_agreement}
...
## Stärkung der Rechte Prostituierter {#stärkung_der_rechte_prostituierter}
...
## Wege zum Bedingungslosen Grundeinkommen {#wege_zum_bedingungslosen_grundeinkommen}
...
### Bedingungsloses Grundeinkommen in Deutschland {#bedingungsloses_grundeinkommen_in_deutschland}
...
### Bedingungsloses Grundeinkommen global {#bedingungsloses_grundeinkommen_global}
...
### Einführungsphase des BGE {#einführungsphase_des_bge}
...
### Ein Grundeinkommen ist nachhaltig zu finanzieren {#ein_grundeinkommen_ist_nachhaltig_zu_finanzieren}
...
### Kombination aus Grundeinkommen und Einkommen/Rente {#kombination_aus_grundeinkommen_und_einkommenrente}
...
### Sozialversicherungen beim Grundeinkommen {#sozialversicherungen_beim_grundeinkommen}
...
## Weiterentwicklung des bestehenden Systems in Vorbereitung zum BGE {#weiterentwicklung_des_bestehenden_systems_in_vorbereitung_zum_bge}
...
### Weiterentwicklung des Sozialsystems {#weiterentwicklung_des_sozialsystems}
...
#### Verbesserung der Einkommenssituation der eingewanderten Menschen und Geflüchtete {#verbesserung_der_einkommenssituation_der_eingewanderten_menschen_und_geflüchtete}
...
#### Erhöhung des Regelsatzes der Mindestsicherungen {#erhöhung_des_regelsatzes_der_mindestsicherungen}
...
#### Abschaffung der Sanktionen bei Hartz IV (§§ 31, 32 SGB II, § 39 a SGB XII) {#abschaffung_der_sanktionen_bei_hartz_iv_31_32_sgb_ii_39_a_sgb_xii}
...
#### Grundsicherung im Alter und bei Erwerbsminderung {#grundsicherung_im_alter_und_bei_erwerbsminderung}
...
##### Grundsätzliche Vorgehensweise zur Bürgerversicherung {#grundsätzliche_vorgehensweise_zur_bürgerversicherung}
...
##### Transparenz bei der privaten Altersvorsorge {#transparenz_bei_der_privaten_altersvorsorge}
...
### Weiterentwicklung des Steuersystems {#weiterentwicklung_des_steuersystems}
...
#### Vereinheitlichung der Umsatzsteuersätze {#vereinheitlichung_der_umsatzsteuersätze}
...
#### Einführung einer Finanztransaktionssteuer {#einführung_einer_finanztransaktionssteuer}
...
#### Vereinfachung der Einkommensteuer {#vereinfachung_der_einkommensteuer}
...
### Maschinen müssen unser Sozialsystem sichern und ausbauen {#maschinen_müssen_unser_sozialsystem_sichern_und_ausbauen}
...
## Commons (Gemeingüter): Vorfahrt für Kooperation, Selbstorganisation und Gemeinsinn {#commons_gemeingüter_vorfahrt_für_kooperation_selbstorganisation_und_gemeinsinn}
...
### Commons als Bildungsaufgabe verstehen {#commons_als_bildungsaufgabe_verstehen}
...
### Mit Commons Teilhabe ermöglichen {#mit_commons_teilhabe_ermöglichen}
...
### Commons Vorrang gewähren {#commons_vorrang_gewähren}
...
### Commons-Projekte anleiten und unterstützen {#commons_projekte_anleiten_und_unterstützen}
...
### Quelloffene Software in der Verwaltung einsetzen {#quelloffene_software_in_der_verwaltung_einsetzen}
...
### Daten offenlegen {#daten_offenlegen}
...
### Internationale wissenschaftliche Vernetzung verbessern {#internationale_wissenschaftliche_vernetzung_verbessern}
...
# **Familie und Gesellschaft** {#familie_und_gesellschaft}
...
### Freie Selbstbestimmung des Zusammenlebens {#freie_selbstbestimmung_des_zusammenlebens}
...
### Andere Lebenspartnerschaften {#andere_lebenspartnerschaften}
...
### Kinderwünsche auch in nicht klassischen Familienbildern realisieren {#kinderwünsche_auch_in_nicht_klassischen_familienbildern_realisieren}
...
### Familienförderung dort, wo Kinder und anderweitig Bedürftige sind! {#familienförderung_dort_wo_kinder_und_anderweitig_bedürftige_sind}
...
### Kostenfreie und flexible Betreuungs- und Bildungsangebote {#kostenfreie_und_flexible_betreuungs__und_bildungsangebote}
...
## Geschlechtsunabhängige Gleichbehandlung bei Hilfsangeboten für Gewaltopfer durchsetzen {#geschlechtsunabhängige_gleichbehandlung_bei_hilfsangeboten_für_gewaltopfer_durchsetzen}
...
## Kinder- und Jugendrechte stärken {#kinder__und_jugendrechte_stärken}
...
### Kinder- und Jugendrechte ins Grundgesetz (GG) {#kinder__und_jugendrechte_ins_grundgesetz_gg}
...
### Klagerecht von Kindern und Jugendlichen sowie rechtliche Beratung von jungen Erwachsenen {#klagerecht_von_kindern_und_jugendlichen_sowie_rechtliche_beratung_von_jungen_erwachsenen}
...
## Akzeptanz der gesellschaftlichen Vielfalt {#akzeptanz_der_gesellschaftlichen_vielfalt}

### Interkulturelle Öffnung der Verwaltung {#interkulturelle_öffnung_der_verwaltung}
...
### Diversität in der Verwaltung: Behörden gehen durch anonymisierte Bewerbungsverfahren mit gutem Beispiel voran {#diversität_in_der_verwaltung_behörden_gehen_durch_anonymisierte_bewerbungsverfahren_mit_gutem_beispiel_voran}
...
### Für eine tolerante und erfolgreiche Arbeitsmarktpolitik {#für_eine_tolerante_und_erfolgreiche_arbeitsmarktpolitik}
...
## Diskriminierung auf allen Ebenen begegnen {#diskriminierung_auf_allen_ebenen_begegnen}
...
### Nachvollziehbare und verantwortliche Erstellung von Studien {#nachvollziehbare_und_verantwortliche_erstellung_von_studien}
...
## Chancengleichheit im Bildungssystem {#chancengleichheit_im_bildungssystem}
...
### Chancengleichheit durch gemeinsames Lernen {#chancengleichheit_durch_gemeinsames_lernen}
...
### Lehrkräfte fördern und sensibilisieren {#lehrkräfte_fördern_und_sensibilisieren}
...
## Freie Selbstbestimmung des Zusammenlebens {#freie_selbstbestimmung_des_zusammenlebens_1}
...
## Förderung queerer Zentren {#förderung_queerer_zentren}
...
## TSG-Reform {#tsg_reform}

Wir PIRATEN fordern die Abschaffung des \"Transsexuellengesetz\", bei gleichzeitiger Übernahme der relevanten Punkte in das BGB. Im Zuge dessen muss eine grundlegende Überarbeitung stattfinden.
...
## Teilhabe im Alltag {#teilhabe_im_alltag}

Wir PIRATEN fordern, dass bei Neu- und Umbauten öffentlicher Gebäude die Vielfalt der Geschlechter berücksichtigt wird. Unisextoiletten, -umkleidekabinen und -wickelräume sind hier unter anderem mögliche Maßnahmen um Geschlechterdiskriminierung zu reduzieren.

## Queer-Asyl {#queer_asyl}
...
## Transparenz im Gesundheitssystem {#transparenz_im_gesundheitssystem}
...
## Patientenvertretung stärken {#patientenvertretung_stärken}
...
## Überversorgung abbauen {#überversorgung_abbauen}

Der Zugang zu medizinischen Angeboten ist für Patientinnen und Patienten heute stark abhängig von ihrem Wohnort. So sind in Großstädten je Einwohner deutlich mehr Ärzte und Krankenhäuser angesiedelt als in ländlichen Regionen. Deshalb streben wir PIRATEN eine Bedarfsplanung an, in der jede Abweichung vom Durchschnitt der Versorgungsdichte öffentlich zu begründen ist. Zur Schließung von Versorgungslücken werden wir uns dafür einsetzen, dass Kommunen das Recht erhalten, hausärztliche Vertragsarztsitze zu übernehmen und dort Ärzte und Krankenhäuser anzustellen.
...
## Unterversorgung vermeiden {#unterversorgung_vermeiden}
...
Wir sehen die Trägervielfalt (öffentliche, frei-gemeinnützige und private Träger) als Anreiz für einen Wettbewerb um die Versorgungsqualität. Gleichzeitig betrachten wir die Gewährleistung der Gesundheitsvorsorge, die adäquate Sicherstellung der Notfallversorgung und die Behandlung von Krankheiten als Fürsorgepflichten des Staates. Deshalb befürworten wir Initiativen, die einen Erhalt von Kliniken in öffentlicher Trägerschaft sowie trägerübergreifende Zusammenarbeit zur Aufrechterhaltung von Versorgungsangeboten vor Ort zum Ziel haben.

## Fehlversorgung beenden {#fehlversorgung_beenden}
...
## Gesundheitsprävention ausbauen {#gesundheitsprävention_ausbauen}
...
## Stärkung der Versorgungsforschung {#stärkung_der_versorgungsforschung}
...
### Forschung für ME/CFS und LongCovid {#forschung_für_mecfs_und_longcovid}
...
## Gesundheitliche Bildung {#gesundheitliche_bildung}
...
## Sichere Bildung während einer Pandemielage {#sichere_bildung_während_einer_pandemielage}
...
## Gesetzliche Verpflichtung zur sauberen Raumluft {#gesetzliche_verpflichtung_zur_sauberen_raumluft}
...
## Vergütungssysteme überprüfen {#vergütungssysteme_überprüfen}
...
## Nach der Pandemie ist vor der Pandemie {#nach_der_pandemie_ist_vor_der_pandemie}
...
## Elektronische Gesundheitskarte {#elektronische_gesundheitskarte}
...
## Pflege in Deutschland {#pflege_in_deutschland}
...
### Pflegequalität und Pflege-Sicherheit {#pflegequalität_und_pflege_sicherheit}
...
#### Verringerung des Verwaltungsaufwandes und der Bürokratie {#verringerung_des_verwaltungsaufwandes_und_der_bürokratie}
...
#### Professionalität fördern und fordern {#professionalität_fördern_und_fordern}
...
#### Fachpersonal schützen {#fachpersonal_schützen}
...
### Arbeitsbedingungen in der Pflege {#arbeitsbedingungen_in_der_pflege}

#### Soziale Absicherung von privaten Pflegepersonen {#soziale_absicherung_von_privaten_pflegepersonen}
...
#### Arbeitsbedingungen für Pflegekräfte verbessern {#arbeitsbedingungen_für_pflegekräfte_verbessern}
...
#### Wissenschaftlich fundierter Personalschlüssel {#wissenschaftlich_fundierter_personalschlüssel}
...
#### Fachkräfte schützen {#fachkräfte_schützen}
...
### Rechte der zu Pflegenden {#rechte_der_zu_pflegenden}

#### Pflege ohne freiheitsentziehende Maßnahmen {#pflege_ohne_freiheitsentziehende_maßnahmen}
...
## Gesundheitsschützende Ausgangsbeschränkungen {#gesundheitsschützende_ausgangsbeschränkungen}
...
## Drogen- und Suchtpolitik {#drogen__und_suchtpolitik}
...
### Neustart: Drogen- und Suchtpolitik {#neustart_drogen__und_suchtpolitik}
...
### Mündigkeit braucht Bildung -- Prävention ist die Grundlage {#mündigkeit_braucht_bildung_prävention_ist_die_grundlage}
...
### Nachhaltige Prävention fängt in der Schule an {#nachhaltige_prävention_fängt_in_der_schule_an}
...
### Prävention als gesamtgesellschaftliche Aufgabe {#prävention_als_gesamtgesellschaftliche_aufgabe}
...
### Verbraucherschutz -- auch für Drogenkonsumenten {#verbraucherschutz_auch_für_drogenkonsumenten}
...
### Nicht stofflich gebundene Süchte {#nicht_stofflich_gebundene_süchte}
...
### Zugang zu medizinischem Cannabis erleichtern {#zugang_zu_medizinischem_cannabis_erleichtern}
...
### Informationelle Selbstbestimmung stärken {#informationelle_selbstbestimmung_stärken}
...
### Entkriminalisierung der Konsumenten {#entkriminalisierung_der_konsumenten}
...
### Herstellung, Anbau und Handel {#herstellung_anbau_und_handel}
...
### Lizenzierte Fachabgabestellen {#lizenzierte_fachabgabestellen}
...
### Keine Einschränkungen für E-Zigaretten {#keine_einschränkungen_für_e_zigaretten}
...
### Keine Willkür beim Führerscheinentzug {#keine_willkür_beim_führerscheinentzug}
...
### Amnestie und Rückgabe der Fahrerlaubnisse {#amnestie_und_rückgabe_der_fahrerlaubnisse}
...
### Verrückt ist auch normal {#verrückt_ist_auch_normal}
...
#### Mehr psychiatrische Abteilungen an allgemeinen Krankenhäusern {#mehr_psychiatrische_abteilungen_an_allgemeinen_krankenhäusern}
...
#### Mehr Psychiatrische Institutsambulanzen {#mehr_psychiatrische_institutsambulanzen}
...
#### Bausteine der komplementären Versorgung {#bausteine_der_komplementären_versorgung}
...
#### Bundesweite Notrufnummer {#bundesweite_notrufnummer}
...
### Arbeitsmarktforderungen in der Psyche {#arbeitsmarktforderungen_in_der_psyche}

#### Fortbildung Interventionskräfte {#fortbildung_interventionskräfte}
...
#### Pflegepersonal in der Psychiatrie {#pflegepersonal_in_der_psychiatrie}
...
### Rechte der psychiatrischen Patienten {#rechte_der_psychiatrischen_patienten}

#### Sonderregelung Arbeitszeiten {#sonderregelung_arbeitszeiten}
...
#### Persönliches Budget {#persönliches_budget}
...
#### Weniger bürokratische Hürden für Patienten {#weniger_bürokratische_hürden_für_patienten}
...
#### Weiterentwicklung von Betreuung {#weiterentwicklung_von_betreuung}
...
### Assistierter Suizid {#assistierter_suizid}
...
### Aktive Sterbehilfe {#aktive_sterbehilfe}
...
## Keine Diskriminierung bei der Blutspende {#keine_diskriminierung_bei_der_blutspende}
...
## Für eine europäische Republik! {#für_eine_europäische_republik}
...
## Demokratie Add-on für Europa {#demokratie_add_on_für_europa}
...
## Europäische Wirtschafts- und Währungsunion {#europäische_wirtschafts__und_währungsunion}
...
## Transparenz und demokratische Kontrolle des ESM {#transparenz_und_demokratische_kontrolle_des_esm}
...
## Die Europäische Union kann ohne Solidarität nicht bestehen {#die_europäische_union_kann_ohne_solidarität_nicht_bestehen}
...
## Europäische Energiepolitik {#europäische_energiepolitik}
...
## Digitale Agenda für Europa {#digitale_agenda_für_europa}
...
## Europäische Innen- und Sicherheitspolitik {#europäische_innen__und_sicherheitspolitik}
...
## Gemeinsame Sicherheits- und Verteidigungspolitik {#gemeinsame_sicherheits__und_verteidigungspolitik}
...
## Europäische Verkehrspolitik {#europäische_verkehrspolitik}
...
# **Außen- und Sicherheitspolitik** {#außen__und_sicherheitspolitik}

## Allgemeiner Fokus (multipolare Welt Veränderung der Gewichte in der Welt -- technologisch und geopolitisch) {#allgemeiner_fokus_multipolare_welt_veränderung_der_gewichte_in_der_welt_technologisch_und_geopolitisch}
...
## Zielsetzung der Außenpolitik {#zielsetzung_der_außenpolitik}
...
## Gemeinsame Verteidigungspolitik {#gemeinsame_verteidigungspolitik}
...
## Europäische Streitkräfte {#europäische_streitkräfte}
...
## Multidimensionale (Territorial) Integrität (MI/MTI) {#multidimensionale_territorial_integrität_mimti}
...
## Digitale Waffen {#digitale_waffen}
...
## BC Waffenkonventionen {#bc_waffenkonventionen}
...
## Globale Menschenrechte stärken {#globale_menschenrechte_stärken}
...
## Ziviles Peacekeeping {#ziviles_peacekeeping}
...
# **Wirtschaft und Finanzen** {#wirtschaft_und_finanzen}
...
## Freiheit in Verantwortung {#freiheit_in_verantwortung}
...
## Nachhaltiges Wirtschaften {#nachhaltiges_wirtschaften}
...
## Verbraucherschutz {#verbraucherschutz_1}
...
### Arbeit und Mensch {#arbeit_und_mensch}
...
### Mindestlohn als Brückentechnologie {#mindestlohn_als_brückentechnologie}
...
### Betriebliche Mitbestimmung {#betriebliche_mitbestimmung}
...
## Abschaffung der Zwangsmitgliedschaft in Kammern und Verbänden (ausgenommen Rechtsanwalts-, Notar- und Ärztekammern) {#abschaffung_der_zwangsmitgliedschaft_in_kammern_und_verbänden_ausgenommen_rechtsanwalts__notar__und_ärztekammern}
...
## Steuerpolitische Maßnahmen {#steuerpolitische_maßnahmen}
...
## Steuerzahler haften nicht für Banken {#steuerzahler_haften_nicht_für_banken}
...
## Einführung einer Rechtsform für Unternehmen mit treuhänderischem Eigentum {#einführung_einer_rechtsform_für_unternehmen_mit_treuhänderischem_eigentum}
...
## Keine Gebühren für verpflichtende Ausweise {#keine_gebühren_für_verpflichtende_ausweise}
...
# **Innen- und Rechtspolitik** {#innen__und_rechtspolitik}

## Politische Transparenz und Antikorruption {#politische_transparenz_und_antikorruption}

### Einflussnahme auf politische Entscheidungen offenlegen {#einflussnahme_auf_politische_entscheidungen_offenlegen}
...
### Einrichtung eines Lobbyregisters für den Deutschen Bundestag {#einrichtung_eines_lobbyregisters_für_den_deutschen_bundestag}
...
### Erweiterung und Verschärfung des Straftatbestandes der Abgeordnetenbestechung {#erweiterung_und_verschärfung_des_straftatbestandes_der_abgeordnetenbestechung}
...
### Verschärfung der Transparenz- und Nebeneinkunftsregeln von Abgeordneten {#verschärfung_der_transparenz__und_nebeneinkunftsregeln_von_abgeordneten}
...
### Eindämmung des politischen Sponsorings {#eindämmung_des_politischen_sponsorings}
...
### Einführung von Karenzzeiten für Spitzenpolitiker {#einführung_von_karenzzeiten_für_spitzenpolitiker}
...
### Anpassung des Abgeordnetengesetzes an die Anforderungen der UN-Konvention gegen Korruption {#anpassung_des_abgeordnetengesetzes_an_die_anforderungen_der_un_konvention_gegen_korruption}
...
## Innere Sicherheit {#innere_sicherheit}

### Die moralische Autorität des Rechtssystems {#die_moralische_autorität_des_rechtssystems}
...
### Ermittlungsschwerpunkte setzen {#ermittlungsschwerpunkte_setzen}

#### Ermittlungsschwerpunkt Jugendkriminalität {#ermittlungsschwerpunkt_jugendkriminalität}
...
#### Ermittlungsschwerpunkt Gewaltkriminalität {#ermittlungsschwerpunkt_gewaltkriminalität}
...
#### Ermittlungsschwerpunkt Steuer-, Korruptions- und Wirtschaftskriminalität {#ermittlungsschwerpunkt_steuer__korruptions__und_wirtschaftskriminalität}
...
##### Korruption im Wirtschaftsleben offenlegen und wirksam bekämpfen {#korruption_im_wirtschaftsleben_offenlegen_und_wirksam_bekämpfen}
...
##### Voraussetzungen für die Verfolgung und Bestrafung von Korruptionsdelikten stärken {#voraussetzungen_für_die_verfolgung_und_bestrafung_von_korruptionsdelikten_stärken}
...
##### Maßnahmen zur Korruptionsprävention und moralische Wertvorstellungen in den unternehmerischen Grundsätzen verankern {#maßnahmen_zur_korruptionsprävention_und_moralische_wertvorstellungen_in_den_unternehmerischen_grundsätzen_verankern}
...
##### Öffentliche Aufträge als Vorbilder für Integritätskriterien und Informationsfreiheit einsetzen {#öffentliche_aufträge_als_vorbilder_für_integritätskriterien_und_informationsfreiheit_einsetzen}
...
### Prävention vor Strafe {#prävention_vor_strafe}

#### Primat der Prävention {#primat_der_prävention}
...
#### Kriminalität ist vielschichtig - Prävention muss es auch sein {#kriminalität_ist_vielschichtig___prävention_muss_es_auch_sein}
...
#### Prävention durch Aufklärung {#prävention_durch_aufklärung}
...
#### Prävention durch eine andere Sucht- und Drogenpolitik {#prävention_durch_eine_andere_sucht__und_drogenpolitik}
...
#### Prävention durch Chancen für alle {#prävention_durch_chancen_für_alle}
...
#### Repression muss der Prävention dienen {#repression_muss_der_prävention_dienen}
...
#### Alternativen zu Haft- und Geldstrafen schaffen {#alternativen_zu_haft__und_geldstrafen_schaffen}
...
#### Strafrechtsreform reformieren {#strafrechtsreform_reformieren}
...
#### Strafrecht muss dem realen Rechtsgüterschutz dienen {#strafrecht_muss_dem_realen_rechtsgüterschutz_dienen}
...
#### Keine Bestrafung bei nur geringem Unrechtsgehalt {#keine_bestrafung_bei_nur_geringem_unrechtsgehalt}
...
#### Abschaffung von bloßem Moralstrafrecht {#abschaffung_von_bloßem_moralstrafrecht}
...
#### Verteidigung der freiheitlich-demokratischen Grundordnung und des Rechtsstaats {#verteidigung_der_freiheitlich_demokratischen_grundordnung_und_des_rechtsstaats}
...
#### Verhängung von Strafen muss besonders gerechtfertigt sein {#verhängung_von_strafen_muss_besonders_gerechtfertigt_sein}
...
#### Kein Verkaufsverbot für Alkohol {#kein_verkaufsverbot_für_alkohol}
...
#### Whistleblower gesetzlich schützen - Umsetzung der EU-Richtlinie zum Hinweisgeberschutz {#whistleblower_gesetzlich_schützen___umsetzung_der_eu_richtlinie_zum_hinweisgeberschutz}
...
### Abmahnwesen reformieren {#abmahnwesen_reformieren}
...
## Stärkung von Zivil- und Katastrophenschutz {#stärkung_von_zivil__und_katastrophenschutz}
...
### Wiederaufnahme der Eigenproduktion von Medikamenten durch den Bund {#wiederaufnahme_der_eigenproduktion_von_medikamenten_durch_den_bund}
...
### Optimierung des Katastrophen- und Zivilschutzwarnsystems {#optimierung_des_katastrophen__und_zivilschutzwarnsystems}
...
### Kommunikation der Notfallpläne {#kommunikation_der_notfallpläne}
...
## Sicherheit in Freiheit {#sicherheit_in_freiheit}

### Sicherheitsbewusstsein stärken {#sicherheitsbewusstsein_stärken}
...
### Systematische Evaluierung von Überwachungsbefugnissen und -programmen {#systematische_evaluierung_von_überwachungsbefugnissen_und__programmen}
...
### Privatsphäre rechtstreuer Bürger achten {#privatsphäre_rechtstreuer_bürger_achten}
...
### Freiheitspaket verabschieden {#freiheitspaket_verabschieden}
...
### Grundrechtskonformität der Gesetzgebung stärken {#grundrechtskonformität_der_gesetzgebung_stärken}
...
### Sicherheitsforschung demokratisieren {#sicherheitsforschung_demokratisieren}
...
### Änderungen am Kriegswaffenkontrollgesetz {#änderungen_am_kriegswaffenkontrollgesetz}
...
### Waffenmissbrauch statistisch besser erfassen {#waffenmissbrauch_statistisch_besser_erfassen}
...
### Evaluierung des Waffenrechts {#evaluierung_des_waffenrechts}
...
## Polizei und Justiz {#polizei_und_justiz}
...
#### Kennzeichnungspflicht für Polizisten {#kennzeichnungspflicht_für_polizisten}
...
#### Angemessene Ausstattung der Gerichte gewährleisten {#angemessene_ausstattung_der_gerichte_gewährleisten}
...
#### Stärkung der Unabhängigkeit der Staatsanwaltschaften {#stärkung_der_unabhängigkeit_der_staatsanwaltschaften}
...
#### Umfassende Beweisverwertungsverbote {#umfassende_beweisverwertungsverbote}
...
#### Kein fliegender Gerichtsstand bei Verstößen im Internet {#kein_fliegender_gerichtsstand_bei_verstößen_im_internet}
...
#### Begründungserfordernis bei ablehnenden Entscheidungen erweitern {#begründungserfordernis_bei_ablehnenden_entscheidungen_erweitern}
...
#### Stärkung der Position des Ermittlungsrichters {#stärkung_der_position_des_ermittlungsrichters}
...
#### Gewährleistung einer 2. Instanz {#gewährleistung_einer_2._instanz}
...
#### Kostenerstattung bei Verfahrenseinstellung {#kostenerstattung_bei_verfahrenseinstellung}
...
#### Mehr Transparenz durch die Veröffentlichung aller Gerichtsentscheidungen {#mehr_transparenz_durch_die_veröffentlichung_aller_gerichtsentscheidungen}
...
#### Protokollierungspflicht für Aussagen vor Gericht {#protokollierungspflicht_für_aussagen_vor_gericht}
...
#### Ton- und Videoaufzeichnungen von Vernehmungen und Gerichtsverhandlungen {#ton__und_videoaufzeichnungen_von_vernehmungen_und_gerichtsverhandlungen}
...
#### Angemessene Entschädigung zu Unrecht Inhaftierter {#angemessene_entschädigung_zu_unrecht_inhaftierter}
...
## Keine Bundeswehr im Inneren {#keine_bundeswehr_im_inneren}
...
# **Trennung von Staat und Religion** {#trennung_von_staat_und_religion}
...
## Weltanschauliche und religiöse Neutralität des Staates {#weltanschauliche_und_religiöse_neutralität_des_staates}
...
## Forschung, Lehre und Bildung {#forschung_lehre_und_bildung}
...
## Finanzierung und Subventionen {#finanzierung_und_subventionen}
...
## Beschäftigte in kirchlichen Einrichtungen {#beschäftigte_in_kirchlichen_einrichtungen}
